    ...
    <a class="dropdown-item" href="javascript:;">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1">
                <h6 class="msg-name">Message <span class="msg-time float-end">today
             </span></h6>
                <p class="msg-info">messae data</p>
            </div>
        </div>
    </a>
     {{-- @empty --}}
    ...
    <a class="dropdown-item" href="javascript:;">
        <div class="d-flex align-items-center">
            <div class="user-online">
                <img src="{{ (!empty($Data->photo)) ? url('upload/admin_images/'.$Data->photo):url('upload/no_image.jpg') }}" class="msg-avatar" alt="user avatar">
            </div>
            <div class="flex-grow-1">
